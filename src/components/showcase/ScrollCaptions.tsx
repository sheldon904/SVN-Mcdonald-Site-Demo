import type { ScrollCaption } from '../../data/showcaseProperties';

interface ScrollCaptionsProps {
  captions: ScrollCaption[];
  progress: number;
}

const ScrollCaptions = ({ captions, progress }: ScrollCaptionsProps) => {
  return (
    <div className="absolute inset-0 pointer-events-none z-10 flex items-end justify-start p-8 md:p-16">
      {captions.map((caption, index) => {
        ...
        // Fade in/out based on distance from center of range
